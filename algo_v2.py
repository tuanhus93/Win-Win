...
pa = threading.Tread(target=avgbar).start()  
pl = threading.Thread(target=lagging).start()  #lagging
pc = threading.Thread(target=conversion).start() # conversion
pb = threading.Thread(target=base).start()  # base
pla = threading.Thread(target=leadingA) # leadingA
plb = threading.Thread(target=leadingB)  # leadingB
pout = threading.Thread(target=output)  # produce the final table, 5*10
